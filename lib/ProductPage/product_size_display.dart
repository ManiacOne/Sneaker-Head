...
class ProductSizesDisplay extends StatefulWidget {
  const ProductSizesDisplay({
    Key? key,
  ...
  @override
  State<ProductSizesDisplay> createState() => _ProductSizesDisplayState();
}

int selectedSizeValue = 0;

class _ProductSizesDisplayState extends State<ProductSizesDisplay> {
  int selectedSize = 0;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection("Products")
          .where("product_id", isEqualTo: widget.widget.productid)
          .snapshots(),
